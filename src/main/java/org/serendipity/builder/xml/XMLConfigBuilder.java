...
/**
 * @author Serendipity
 * @description 读取xml配置文件，对Configuration进行初始化操作
...
public class XMLConfigBuilder extends BaseBuilder {
    ...
    /**
     * 解析Mapper文件的同时，创建MS，并将其插入Configuration
     * @param mappers
     * @throws Exception
     */
